...
export class UserRegisterComponent implements OnInit, ControlValueAccessor, MatFormFieldControl<MyTel>, OnDestroy {
  static nextId = 0;
  ...
  id = `example-tel-input-${UserRegisterComponent.nextId++}`;
  describedBy = '';
  onChange = (_: any) => {};
  onTouched = () => {};
